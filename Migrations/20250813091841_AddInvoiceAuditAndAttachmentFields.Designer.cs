...
namespace License_Tracking.Migrations
{
    ...
    [Migration("20250813091841_AddInvoiceAuditAndAttachmentFields")]
    partial class AddInvoiceAuditAndAttachmentFields
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("License_Tracking.Models.Payment", b =>
                {
                    b.HasOne("License_Tracking.Models.CbmsInvoice", "CbmsInvoice")
                        .WithMany()
                        .HasForeignKey("InvoiceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("CbmsInvoice");
                });
